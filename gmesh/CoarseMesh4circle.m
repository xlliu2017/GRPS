function[pc,ec,tc]=CoarseMesh4circle(Nc)
...
% global N; 
% global Hmax;    
global j;                  % this variable wase used in the initmesh
N=Nc; Hmax = 0.33; j=log2(Nc)-2;
% [pc, ec, tc] = initmesh('unitsquare_cg', 'Hmax', inf); % this will use N

[pc, ec, tc] = initmesh('unicircle_nonuniform_cg', 'Hmax', inf);