function [x,y]=unicircle_nonuniform_cg(bs,s)
%UNITSQUAREG_CG   Gives geometry data for the coarse geometry of squareg
%                 PDE model
%
...
[pc, ec, tc] = initmesh('circlefunction','Hmax',1.2,'jiggle', 'on');
for i =1:j
[pc,ec,tc]=refinemesh('circlefunction',pc,ec,tc,'regular');
end
