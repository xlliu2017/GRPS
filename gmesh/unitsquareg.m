...
%UNITSQUAREG   Gives geometry data for the squareg PDE model
%
%   NE=UNITSQUAREG gives the number of boundary segment
%
%   D=UNITSQUAREG(BS) gives a matrix with one column for each boundary segment
%   specified in BS.
...
%
%   [X,Y]=UNITSQUAREG(BS,S) gives coordinates of boundary points. BS specifies the
%   boundary segments and S the corresponding parameter values. BS may be
%   a scalar.

% Copyright 1994-2003 The MathWorks, Inc.
% $Revision: 1.8.4.2 $
% adapted by Lei Zhang, Oct 06, 2012, the square changed from [-1, 1] x 
% [-1, 1]to [0, 1] x [0, 1]
